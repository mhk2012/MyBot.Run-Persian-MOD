...
$lblGtfoHelp = 0, $lblKick = 0, $lblGtfoTroop = 0, $lblGtfoTroopBoost = 0, $lblGtfoSpellBoost = 0, $lblGtfoChat = 0, $lblGtfoIdle = 0, $txtGtfoIdleTime = 0, $chkChatStatus = 0, $cmbGtfoTroopBoost = 0, _
$cmbGtfoSpell = 0, $cmbGtfoSpellBoost = 0, $lblGtfoFriend = 0, $cmbFriendRequest = 0, $lblGtfoChatIdleDelay = 0, $cmbGtfoChatIdleDelay = 0, $lblGtfoSpell = 0, $chkClanOpen = 0, $GtfoChatCount = 0, _
$GtfoHours = 0, $GtfoMins = 0, $GtfoSecs = 0, $aIsGoldBar = 0, $GtfoTroopType = 0, $ClickResult = 0, $CurrentTrophiesIndex = 0, $debugOcr = 0, $aGtfoCanTrophies = 0
...
Func CreateVillageDonate()
	...
	Local $x = 82
	$g_hChkDonate = GUICtrlCreateCheckbox("", $x + 291, 6, 13, 13)
...
Func CreateGTFOSubTab()
	...
	GUISwitch($hGUI_GTFOMode)
		...
		$grpGtfo = GUICtrlCreateGroup(" GTFO - Free Man Style && Mass Donation MOD  Ver 5.2 Beta (By Media Hub) ", 0, 0, 430, 375, BitOR($GUI_SS_DEFAULT_GROUP,$BS_CENTER))
			...
			Global $bIconStart = _GUIImageList_Create(24, 24, 4)
				...
				_GUIImageList_AddBitmap($bIconStart, @ScriptDir & "\images\Button\play.bmp")
			Global $bIconPause = _GUIImageList_Create(24, 24, 4)
				...
				_GUIImageList_AddBitmap($bIconPause, @ScriptDir & "\images\Button\pause.bmp")
			Global $bIconResume = _GUIImageList_Create(24, 24, 4)
			...
			Global $bIconStop = _GUIImageList_Create(24, 24, 4)
...
;~ 				GUICtrlSetTip(-1, "Open the Clan If Clan is closed")
			$cmbTroopIdleTime = GUICtrlCreateCombo("", 365, 28, 55, 25, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL, $WS_VSCROLL))
				GUICtrlSetData(-1, "5|7|10|13|17|20|25|30|35|40|Auto", "Auto")
...
;~ 				 _GUICtrlComboBoxEx_EndUpdate($cmbGtfoTroop)
			...
			$lblGtfoChatIdleDelay = GUICtrlCreateLabel("Chat Delay", 110, 300, 60, 17)
				GUICtrlSetColor(-1, 0x0000FF)
				GUICtrlSetTip(-1, "Chat Randomize Delay use According yo your Clan Need..")
			$cmbGtfoChatIdleDelay = GUICtrlCreateCombo("", 175, 297, 40, 25, BitOR($CBS_DROPDOWNLIST,$CBS_AUTOHSCROLL,$WS_VSCROLL))
				GUICtrlSetData(-1, "10|15|20|25|30|35|40|45|50|55|60|65|70" , "15")
				GUICtrlSetOnEvent(-1,"GtfoSetChatIdleTime")
