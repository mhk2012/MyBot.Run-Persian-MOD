...
Func CreateAttackSearchDeadBaseSearch()
	...
	$y += 75
	$x = 10
		$g_hChkDBNotWaitHeroes = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkNotWaitHeroes", "Don't wait for heroes when upgrade"), $x, $y, -1, -1)
