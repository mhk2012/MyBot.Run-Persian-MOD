...
Func ChatbotMessage() ; run the chatbot
	If $g_iGlobalChat Or $g_iClanChat Then SetLog("Chatbot: Sending some chats", $COLOR_GREEN)
	...
	If $g_iClanChat Then
		...
		If Not ChatbotChatClose() Then Return
	EndIf
	If $g_iGlobalChat Or $g_iClanChat Then SetLog("Chatbot: Done chatting", $COLOR_GREEN)
