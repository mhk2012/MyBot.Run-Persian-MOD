...
Func UpdateBotTitle()
	Local $sTitle = "My Bot " & $g_sBotVersion & " - " & "Persian MOD" & " " & $g_sModversion & " -"
...
Func FinalInitialization(Const $sAI)
	...
	SetLog("___________ " & "Persian MOD" & "___________", $COLOR_MONEYGREEN, "Impact", 14)
	...
	SetLog("                         » " & "Persian MOD" & " " & $g_sModversion & " «", $COLOR_TEAL, "Segoe UI Semibold", 10)
	SetLog("-----------------------------------------------------------------------", $COLOR_MONEYGREEN)
